                        ...
                        <form className="mt-3">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group">
                                        <TextField label="Tên" type="text" required variant="standard" className="w-100" />
                                    </div>
                                </div>

                                <div className="col-md-6">
                                    <div className="form-group">
                                        <TextField label="Số Điện Thoại" type="text" required variant="standard" className="w-100" />
                                    </div>
                            ...
                            <div className="d-flex align-items-center mt-3 mb-3 w-100">
                                <div className="row" style={{width: '500px'}}>
                                    <div className="col-6">
                                        <Button className="btn-blue w-100 btn-lg btn-big">Đăng Ký</Button>
                                    </div>
                                    <div className="col-6">
                                        <Link to="/">
                            ...
                            <p className="txt">Bạn chưa có tài khoản? <Link to="/signIn" className="border-effect">Đăng Nhập</Link></p>
